...
const SECTIONS = [
  ...
  { id: 'revenueQuality',  title: 'Revenue quality',           subtitle: 'Pricing power per bed & patient',
    metrics: ['arpob', 'arpp', 'revenuePerBedYearly', 'revenueGrowthYoy'] },
  { id: 'profitability',   title: 'Profitability & returns',   subtitle: 'Margin & capital efficiency',
    metrics: ['revenue', 'ebitda', 'ebitdaMargin', 'pat', 'ebitdaPerBedYearly', 'roce'] },
  { id: 'expansion',       title: 'Expansion & capital',       subtitle: 'Growth trajectory',
    metrics: ['capexAnnounced', 'netDebt'] },
